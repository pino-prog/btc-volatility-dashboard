...
// JOLTS: NFP 발표 약 4주 후
// ────────────────────────────────────────────────────────────────
// 검증 출처: BLS 공식 일정 + bls.gov 아카이브 URL 패턴 (예: cpi_03112026.htm)
// 마지막 검증: 2026-05-21 (5개 카테고리 cross-check 에이전트)
// 주의: 2025-10/11 미 정부 셧다운 여파로 일부 일정 재조정됨
const BLS_2026 = {
  CPI:  [
    // 발표일 → 대상 데이터 월
    ['2026-01-13', '12월'], ['2026-02-13', '1월'],  ['2026-03-11', '2월'],
    ['2026-04-10', '3월'],  ['2026-05-12', '4월'],  ['2026-06-10', '5월'],
    ['2026-07-14', '6월'],  ['2026-08-12', '7월'],  ['2026-09-11', '8월'],
    ['2026-10-14', '9월'],  ['2026-11-10', '10월'], ['2026-12-10', '11월'],
  ],
  NFP:  [
    ['2026-01-09', '12월'], ['2026-02-06', '1월'],  ['2026-03-06', '2월'],
    ['2026-04-03', '3월'],  ['2026-05-01', '4월'],  ['2026-06-05', '5월'],
    ['2026-07-03', '6월'],  ['2026-08-07', '7월'],  ['2026-09-04', '8월'],
    ['2026-10-02', '9월'],  ['2026-11-06', '10월'], ['2026-12-04', '11월'],
  ],
  PPI:  [
    ['2026-01-14', '12월'], ['2026-02-11', '1월'],  ['2026-03-18', '2월'],
    ['2026-04-14', '3월'],  ['2026-05-13', '4월'],  ['2026-06-11', '5월'],
    ['2026-07-14', '6월'],  ['2026-08-11', '7월'],  ['2026-09-09', '8월'],
    ['2026-10-13', '9월'],  ['2026-11-11', '10월'], ['2026-12-09', '11월'],
  ],
};
